	    				...
	    				<table class="table">
						    ...
						    <tbody>
						      <tr class="text-center">
						        ...
						        <td class="image-prod"><div class="img" style="background-image:url('<%=request.getContextPath()%>/images/Nước ép nho.jpg');"></div></td>
						        
						        <td class="product-name">
						        	<h3>Nước Nho</h3>
						        	<p>Nho đã qua sàn lọc và kiểm thử</p>
						        </td>
						      ...
						      <tr class="text-center">
						        ...
						        <td class="image-prod"><div class="img" style="background-image:url('<%=request.getContextPath()%>/images/Trà sữa việt quất.jpg');"></div></td>
						        
						        <td class="product-name">
						        	<h3>Trà Sữa Việt Quất</h3>
						        	<p>Có một độ chua nhất định đến từ những trái việt quất tươi ngon</p>
						        </td>
