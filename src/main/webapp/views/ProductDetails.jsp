                        ...
                        <nav class="navbar navbar-expand-lg bg-light">
                            <div class="container-fluid">
                                <a class="navbar-brand" href="#">
                                    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#newProductDetailsModal">
                    ...
                    <div class="card-body">
                        ...
                        <table id="example1" class="table table-bordered table-striped text-center">
                            ...
                            <tr>
                                ...
                                <th>Product ID</th>
                                <th>Size Id</th>
                                <th>Price ProductDetails</th>
                                <th>ProductDetails Status</th>
                                <th colspan="2">Action</th>
                            </tr>
                            </thead>
                            <tbody>
                            <c:forEach items="${productDetailsList}" var="proDt">
                                <tr>
                                    <td>${proDt.proDetailsId}</td>
                                    <td>${proDt.productId}</td>
                                    <td>${proDt.sizeId}</td>
                                    <td>${proDt.pricePrDt}</td>
                                    <td>${proDt.proDtStatus?"Hoạt Động":"Không Hoạt Động"}</td>
                                    <td>
                                        <button type="button" class="btn btn-warning"><a href="<%=request.getContextPath()%>/ProductDetailsServlet?proDetailsId=${proDt.proDetailsId}&&action=Update">Edit</a></button>
                                    </td>
                                    <td>
                                        <button type="button" class="btn btn-danger"><a href="<%=request.getContextPath()%>/ProductDetailsServlet?proDetailsId=${proDt.proDetailsId}&&action=delete">Delete</a></button>
                                    </td>
                                </tr>
                            </c:forEach>
                            </tbody>
                        ...
                        <div class="modal fade" id="newProductDetailsModal" tabindex="-1" aria-labelledby="newProductDetailsLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <form action="<%=request.getContextPath()%>/ProductDetailsServlet" method="post">
                                        <div class="modal-body">
                                            <div class="input-group mb-3">
                                                <label class="input-group-text" for="productId">ProductId</label>
                                                <select class="form-select" id="productId" name="productId">
                                                    <c:forEach items="${productList}" var="prDt">
                                                        <option value="${prDt.productId}">${prDt.productName}</option>
                                                    </c:forEach>
                                                </select>
                                            </div>
                                            <div class="input-group mb-3">
                                                <label class="input-group-text" for="sizeId">Size</label>
                                            ...
                                            <div class="input-group mb-3">
                                                <span class="input-group-text" id="pricePrDt">Price</span>
                                                <input type="number" name="pricePrDt" class="form-control" placeholder="Input pricePrDt"
                                                       aria-label="pricePrDt" aria-describedby="basic-addon1">
                                            </div>
                                            <div class="input-group mb-3">
                                                <label class="input-group-text" for="proDtStatus">ProductDetails Status</label>
                                                <select class="form-select" id="proDtStatus" name="proDtStatus">
