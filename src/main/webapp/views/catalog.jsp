                        ...
                        <table id="example1" class="table table-bordered table-striped text-center" border="1">
                            ...
                            <c:forEach items="${listCatalog}" var="cat">
                                <tr>
                                    ...
                                    <td>
                                            ${cat.catalogStatus?"Hoạt Động":"Không Hoạt Động "}
                                    </td>
                                    <td>
                                        <button type="button" class="btn btn-warning"><a href="<%=request.getContextPath()%>/CatalogServlet?catalogId=${cat.catalogId}&&action=update">Update</a></button>
                                    </td>
                                    <td>
                                        <button type="button" class="btn btn-danger"><a href="<%=request.getContextPath()%>/CatalogServlet?catalogId=${cat.catalogId}&&action=delete">Delete</a></button>
                                    </td>
                                </tr>
                            </c:forEach>
                            </tbody>
                                    ...
                                    <form action="<%=request.getContextPath()%>/CatalogServlet" method="post">
                                        <div class="modal-body">
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="text" name="catalogId" class="form-control" placeholder="Input catalog id"
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <select class="form-select" id="catalogStatus" name="CatalogStatus">
