          ...
          <div class="card-body">
            <form action="<%=request.getContextPath()%>/SizeServlet" method="post">
              <table id="example1" class="table table-bordered table-striped text-center" border="1">
                <tr>
                  <td>Size Id</td>
                  <td><input type="text" name="sizeId" value="${sizeUpdate.sizeId}"readonly></td>
                </tr>
                <tr>
                  <td>Size Name</td>
                  <td><input type="text" name="sizeName" value="${sizeUpdate.sizeName}"></td>
                </tr>
                <tr>
                  <td>Size Status</td>
                  <td>
                    <c:choose>
                      <c:when test="${sizeUpdate.sizeStatus}">
                        <input type="radio" name="sizeStatus" id="Active" value="true" checked/><lable for="Active">Hoạt Động</lable>
                        <input type="radio" name="sizeStatus" id="InActive" value="false"/><lable for="InActive">Không Hoạt Động</lable>
                      </c:when>
                      <c:otherwise>
                        <input type="radio" name="sizeStatus" id="Active" value="true" /><lable for="Active">Hoạt Động</lable>
                        <input type="radio" name="sizeStatus" id="InActive" value="false"checked/><lable for="InActive">Không Hoạt Động</lable>
                      </c:otherwise>
                    </c:choose>
