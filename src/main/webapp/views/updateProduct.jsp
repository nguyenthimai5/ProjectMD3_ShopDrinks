          ...
          <div class="card-body">
            <form action="<%=request.getContextPath()%>/ProductServlet" method="post">
              <table id="example1" class="table table-bordered table-striped text-center" border="1">
                <tr>
                  <td>Product Id</td>
                  <td><input type="text" name="productId" value="${proUpdate.productId}"readonly></td>
                </tr>
                <tr>
                  <td>Product Name</td>
                ...
                <tr>
                  <td>Quantity</td>
                  <td><input type="number" name="quatity" value="${proUpdate.quatity}"></td>
                </tr>
                <tr>
                  <td>Image</td>
                  <td> <img src="<%=request.getContextPath()%>/images/${proUpdate.image}" width="80px" height="50px" alt="${proUpdate.image}">
