            ...
            <div class="container-fluid p-0">
                <div class="card">
                    ...
                    <div class="card-body">
                        <table id="example1" class="table table-bordered table-striped text-center" border="1">
                            ...
                            <c:forEach items="${sizeList}" var="size">
                                <tr>
                                    ...
                                    <td>${size.sizeName}</td>
                                    <td>
                                            ${size.sizeStatus?"Hoạt Động":"Không Hoạt Động "}
                                    </td>
                                    <td>
                                        <button type="button" class="btn btn-warning"><a href="<%=request.getContextPath()%>/SizeServlet?sizeId=${size.sizeId}&&action=update">Update</a></button>
                                    </td>
                                    <td>
                                        <button type="button" class="btn btn-danger"><a href="<%=request.getContextPath()%>/SizeServlet?sizeId=${size.sizeId}&&action=delete">Delete</a></button>
                                    </td>
                                </tr>
                            </c:forEach>
                            </tbody>
                        ...
                        <div class="modal fade" id="newSizeModal" tabindex="-1" aria-labelledby="newSizeLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <form action="<%=request.getContextPath()%>/SizeServlet" method="post">
                                        <div class="modal-body">
                                            <div class="input-group mb-3">
                                                <span class="input-group-text" id="sizeId">Size Id</span>
                                                <input type="text" name="sizeId" class="form-control" placeholder="Input size id"
                                                       aria-label="SizeId" aria-describedby="basic-addon1">
                                            </div>
                                            <div class="input-group mb-3">
                                                <span class="input-group-text" id="sizeName">Size Name</span>
                                                <input type="text" name="sizeName" class="form-control" placeholder="Input size name"
                                                       aria-label="Size Name" aria-describedby="basic-addon1">
                                            </div>
                                            <div class="input-group mb-3">
                                                <label class="input-group-text" for="sizeStatus">Size Status</label>
                                                <select class="form-select" id="sizeStatus" name="sizeStatus">
